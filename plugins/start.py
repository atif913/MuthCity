...
# ------------------------------------------------------------------------------------
# SUBSCRIBED START COMMAND (MAIN START)
# ------------------------------------------------------------------------------------
@Bot.on_message(filters.command('start') & filters.private & subscribed)
async def start_command(client: Client, message: Message):

    # -------------- NEW: FORCE SUB CHECK FOR BOTH CHANNELS ----------------
...
# ------------------------------------------------------------------------------------
# NOT-SUBSCRIBED START HANDLER (FORCE SUB MESSAGE)
# ------------------------------------------------------------------------------------
...
async def not_joined(client: Client, message: Message):
    ...
    if FORCE_SUB_CHANNEL:
        if bool(JOIN_REQUEST_ENABLE):
            ...
            url1 = invite1.invite_link
        else:
            url1 = client.invitelink

        buttons.append([InlineKeyboardButton("Join Channel 1", url=url1)])

    # CHANNEL 2
    if FORCE_SUB_CHANNEL_2:
        url2 = client.invitelink2
        buttons.append([InlineKeyboardButton("Join Channel 2", url=url2)])
